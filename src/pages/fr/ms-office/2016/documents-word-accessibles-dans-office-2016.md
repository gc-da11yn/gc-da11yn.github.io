...
1. Contraste des couleurs et utilisation de la couleur.
2. En-tête et pied de page.
3. Taille des caractères, police et espacement du contenu.
4. Styles cohérents pour les titres, les listes, etc.

Comment créer un modèle&nbsp;:

1. Activez l’onglet **Fichier** sur le ruban > **Enregistrer sous**.
2. Activez **Ordinateur** et choisissez un dossier dans lequel enregistrer votre modèle.
...
1. Activez l’onglet **Fichier** sur le ruban > **Ouvrir**.
2. Activez **Ordinateur**.
3. Cliquez sur l’icône **Parcourir**.
4. Ouvrez le dossier « **Modèles personnalisés Office** » dans **Mes documents**.
5. Sélectionnez le modèle que vous avez créé et activez **Ouvrir**.
6. Apportez les modifications désirées, puis enregistrez et fermez le modèle.
...
1. Sélectionnez le texte qui semble être un titre.
...
1. Sélectionnez l’onglet Insérer à partir du ruban.
2. Dans la section **En-têtes et pieds de page** du ruban, sélectionnez « **En-tête** » ou « **Pied-bas** ».
...
Word offre des fonctionnalités pour créer des listes ordonnées (numérotées) ou non (à puces).
...
3. Activez l’outil **Disposition et propriétés**.
4. Saisissez un titre dans le champ **Titre**. Remarque : Ne remplissez ce champ que si vous saisissez une longue explication dans le champ Description.
...
1. Ouvrez le menu contextuel du graphique ou du diagramme et activez **Format de la zone de graphique**.
2. Le menu **Format de la zone de graphique** s’ouvre.
...
- <a href="https://webaim.org/techniques/word/">WebAIM : Créer des documents accessibles dans Microsoft Word <span lang="fr">(en anglais seulement)</span></a>
