...
## Liens
Utilisez **toujours** un texte de lien significatif pour que le lecteur sache où le lien le mène, par exemple « <u>Services partagés Canada</u> », au lieu de « cliquez ici ».
...
1.	tous les objets de la diapositive (appuyez sur les touches <kbd>Ctrl</kbd> + <kbd>A</kbd>);
2.	l’onglet **Révision**;
...
1.	appuyez sur <kbd>Alt</kbd>, <kbd>F</kbd>, <kbd>I</kbd>, <kbd>UA</kbd> ou sélectionnez l’onglet **Fichier** > le menu **Exporter** > le sous-menu **Créer un document PDF/XPS** > **Créer PDF/XPS**;
