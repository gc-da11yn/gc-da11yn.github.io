---
title: "Standard on Information and Communication Technology Accessibility Phase One Requirements Backgrounder"
layout: layouts/base.njk
description: "<p>This document provides an overview of the requirements we plan to include in phase 1 of the <em>Standard on Information and Communication Technology Accessibility</em>.</p>
...
The release of the _[Accessible Canada Act](https://laws-lois.justice.gc.ca/eng/acts/A-0.6/)_, the [Accessibility Strategy for the Public Service of Canada](https://www.canada.ca/en/government/publicservice/wellness-inclusion-diversity-public-service/diversity-inclusion-public-service/accessibility-public-service/accessibility-strategy-public-service-toc/accessibility-strategy-public-service-technology.html) and the [Guideline for Making Information Technology Usable for All](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32620) in 2019 led to many initiatives across the Government of Canada to make ICT barrier-free. One of these initiatives was the drafting of the _Standard on Information and Communication Technology Accessibility_. This standard, which will replace the _Standard on Web Accessibility_, will expand the scope of accessibility requirements under the _Policy on Service and Digital_. The standard will be harmonized with the _[Harmonised European Standard on Accessibility Requirements for ICT Products and Services (2021) (EN 301 549)](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf)_ to: meet all relevant requirements in the act and strategy; align with international best practices; and align with EN 301 549 (2021 and future updates).
...
An accompanying scorecard and maturity model are being developed for departments to use to assess their progress towards achieving the goal of making ICT usable by all.
...
To make sure all new ICT used in the federal government is accessible, and to give departments time to make existing technology accessible, we are publishing the standard in two phases:
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.1.1</td>
      <td>Departments must meet the latest version of the <em>Harmonized European Standard on Accessibility requirements for ICT products and services</em> (EN 301 549) accessibility requirements when procuring new ICT products and services, while adhering to the <em>Directive on the Management of Procurement</em>;</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

When a department enters a new contract with a vendor, it will need to make sure the product or service it is procuring is accessible by satisfying the applicable clauses in the latest version of the _[Harmonised European Standard on Accessibility Requirements for ICT Products and Services](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf) (2021) (EN 301 549)_.
Technical authorities and contracting authorities who work in the Government of Canada can consult Shared Services Canada’s [Accessible ICT Procurement Guide](https://www.gcpedia.gc.ca/gcwiki/images/e/e4/AccessibleICTProcurementGuide_31May2022_EN.docx) for more information and guidance prior to the publication of official standard guidance.
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.2.1</td>
      <td>All new web content must conform with <a href="https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf">EN 301 549</a> and include an accessibility statement</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

After we publish Phase 1 of the standard, all new web content (public-facing **and** internal web) will have to be accessible and satisfy the clauses in EN 301 549.
...
- the level of accessibility of the website (according to the EN 301 549/WCAG 2.1 assessment criteria)
...
- the level of accessibility of the web page (according to the EN 301 549/WCAG 2.1 assessment criteria)
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.2.4</td>
      <td>Accessibility conformance testing against the <em>EN 301 549</em> standard must be conducted for all existing internal-facing web content used by the department</td>
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.4.1</td>
      <td>All new enterprise and departmental software must conform with <a href="https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf">EN 301 549 (PDF, 2.3MB)</a> and include an accessibility statement</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

Following the publication of the Standard on ICT Accessibility (Phase 1), all new enterprise and departmental software will need to satisfy the clauses in EN 301 549
...
- the level of accessibility of the software application (according to the EN 301 549/WCAG 2.1 assessment criteria)
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.5.1</td>
      <td>All new native mobile applications must conform with <a href="https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf">EN 301 549<a> and include an accessibility statement</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

After Phase 1 of the standard takes effect, all new native mobile applications will need to satisfy the applicable clauses in EN 301 549.
...
- the level of accessibility of the mobile application (according to the EN 301 549/WCAG 2.1 assessment criteria)
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.5.2</td>
      <td>Accessibility conformance testing against the latest version of <a href="https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf">EN 301 549<a> standard must be conducted for all existing native mobile applications used by the department</td>
      <td>Effective date of standard + 24 months</td>
    </tr>
  </tbody>
</table>
...
Hardware includes keyboards, computer mice, and stationary ICT. Any feature that improves accessibility (i.e., text-to-speech, closed-captioning, and keyboard shortcuts, etc.) on any new hardware will need to be made available to all users from the outset.
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.7.1</td>
      <td>Departments must provide mechanisms for users to give feedback on the accessibility of ICT</td>
      <td>Effective date of standard</td>
    </tr>
  </tbody>
</table>

Whatever ICT is being used; users will need a mechanism for providing feedback to the department on accessibility issues. Departments can do this is by integrating a user feedback form into their ICT.

## Workforce capacity and capabilities

### Training and tools for accessibly ICT
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.8.2</td>
      <td>Departments must provide learning opportunities for all employees, including executives, on accessibility legislation, policies, and responsibilities for creating accessible ICT</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

Accessibility benefits everyone and its implementation is all our responsibility. Departments are responsible for making sure that learning opportunities are provided to their staff, such as training about accessibility, intersectionality, and unconscious bias.
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.8.3</td>
      <td>Departments must provide learning opportunities on accessibility requirements for employees who procure, develop or implement ICT.</td>
      <td>Effective date of standard + 12 months</td>
    </tr>
  </tbody>
</table>

Departments are responsible for making sure learning opportunities are provided to employees who work in ICT. Learning could cover topics such as accessible procurement, accessible web design, and planning and performance reporting against this standard.
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td>2.1.9.2</td>
      <td>Departments must report on the progress of ICT accessibility implementation in their departments according to guidance and accessibility measurement tools. These would be included in their accessibility plans and progress reports under the Accessible Canada Act.</td>
      <td>Effective date of standard</td>
    </tr>
  </tbody>
</table>

Under the _Accessible Canada Act_, departments must publish a report on their progress on fulfilling the priorities set out in their departmental accessibility plan. In compiling this report, departments will use the ICT accessibility measurement scorecard and maturity model.

## Exceptions

Departments will be able to request an exception to the requirements in this standard in certain defined circumstances. Departments that are granted an exception will still have to provide a roadmap that details how the ICT product or procured good/service will be conformant with this standard.
